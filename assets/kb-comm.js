...
/* ---------- Floating "Call Us" button (matches WhatsApp float) ---------- */
(function(){function kbCall(){if(document.getElementById('kbCallFloat'))return;var css=document.createElement('style');css.textContent='#kbCallFloat{position:fixed;right:18px;bottom:18px;z-index:9500;display:flex;align-items:center;gap:8px;background:#2563EB;color:#fff;text-decoration:none;padding:12px 18px;border-radius:50px;font:600 15px/1 system-ui,-apple-system,sans-serif;box-shadow:0 6px 22px rgba(0,0,0,.28);transition:transform .15s}#kbCallFloat:hover{transform:translateY(-2px) scale(1.03)}#kbCallFloat svg{width:22px;height:22px;fill:#fff}@media(max-width:520px){#kbCallFloat span{display:none}#kbCallFloat{padding:14px;border-radius:50%;bottom:18px}}';document.head.appendChild(css);var c=document.createElement('a');c.id='kbCallFloat';c.href='tel:+919514524599';c.innerHTML='<svg viewBox="0 0 24 24"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.5.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.6 21 3 13.4 3 4c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.2.2 2.4.6 3.5.1.4 0 .8-.3 1l-2.2 2.3z"/></svg><span>Call Us</span>';document.body.appendChild(c);}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',kbCall);}else{kbCall();}})();
